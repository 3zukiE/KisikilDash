    ...
    Array.prototype.forEach.call(
      ...
      function (source) {
        for (var property in source) {
          console.assert(
            !this[property],
            "tm error: {0} is Already".format(property)
          );
          this[property] = source[property];
        }
      },
...
(function () {
  ...
  Array.prototype.$method("deepEquals", function (arr) {
    ...
    for (var i = 0, len = this.length; i < len; ++i) {
      var result = this[i].deepEquals
        ? this[i].deepEquals(arr[i])
        : this[i] === arr[i];
      if (result === false) {
        return false;
      }
    ...
    if (level) {
      ...
      arr = this.reduce(function (previousValue, curentValue) {
        return Array.isArray(curentValue)
          ? previousValue.concat(curentValue.flatten())
      ...
      while (true) {
        ...
        var value =
          typeof callback === "function"
            ? callback.bind(context || this)(iteratorResult.value)
  ...
  phina.define("phina.geom.Collision", {
    _static: {
      ...
      testCircleCircle: function (circle0, circle1) {
        var distanceSquared = phina.geom.Vector2.distanceSquared(
          circle0,
          circle1
        );
...
phina.namespace(function () {
  ...
  phina.define("phina.util.Support", {
    _static: {
      ...
      webGL: (function () {
        return (
          !!phina.global.CanvasRenderingContext2D &&
          !!document.createElement("canvas").getContext("webgl")
        );
      })(),
      webAudio:
        !!phina.global.AudioContext ||
        !!phina.global.webkitAudioContext ||
        !!phina.global.mozAudioContext,
    },
  });
});
...
phina.namespace(function () {
  ...
  (function () {
    ...
    methodMap.forIn(function (old, name) {
      phina.util.EventDispatcher.prototype.$method(
        old,
        phina.util.EventDispatcher.prototype[name]
      );
    });
  })();
});
  ...
  phina.define("phina.util.Tween", {
    ...
    _accessor: {
      easing: {
        ...
        set: function (v) {
          this._easing =
            phina.util.Tween.EASING[v] || phina.util.Tween.EASING.default;
        },
      },
    },
    ...
    _static: {
      ...
      EASING: {
        ...
        easeOutInCubic: function (t, b, c, d) {
          ...
          return phina.util.Tween.EASING.easeInCubic(
            t * 2 - d,
            b + c / 2,
            c / 2,
            d
        ...
        easeOutInQuart: function (t, b, c, d) {
          ...
          return phina.util.Tween.EASING.easeInQuart(
            t * 2 - d,
            b + c / 2,
            c / 2,
            d
        ...
        easeOutInQuint: function (t, b, c, d) {
          ...
          return phina.util.Tween.EASING.easeInQuint(
            t * 2 - d,
            b + c / 2,
            c / 2,
            d
        ...
        easeOutInSine: function (t, b, c, d) {
          ...
          return phina.util.Tween.EASING.easeInSine(
            t * 2 - d,
            b + c / 2,
            c / 2,
            d
        ...
        easeOutInExpo: function (t, b, c, d) {
          ...
          return phina.util.Tween.EASING.easeInExpo(
            t * 2 - d,
            b + c / 2,
            c / 2,
            d
        ...
        easeOutInCirc: function (t, b, c, d) {
          ...
          return phina.util.Tween.EASING.easeInCirc(
            t * 2 - d,
            b + c / 2,
            c / 2,
            d
        ...
        easeOutInElastic: function (t, b, c, d, a, p) {
          if (t < d / 2)
            return phina.util.Tween.EASING.easeOutElastic(
              t * 2,
              b,
              c / 2,
              d,
          ...
          return phina.util.Tween.EASING.easeInElastic(
            t * 2 - d,
            b + c / 2,
            c / 2,
            d,
        ...
        easeOutInBack: function (t, b, c, d, s) {
          ...
          return phina.util.Tween.EASING.easeInBack(
            t * 2 - d,
            b + c / 2,
            c / 2,
            d,
        ...
        easeInOutBounce: function (t, b, c, d) {
          if (t < d / 2)
            return (
              phina.util.Tween.EASING.easeInBounce(t * 2, 0, c, d) * 0.5 + b
            );
          else
            return (
              phina.util.Tween.EASING.easeOutBounce(t * 2 - d, 0, c, d) * 0.5 +
              c * 0.5 +
              b
            );
        },
        ...
        easeOutInBounce: function (t, b, c, d) {
          ...
          return phina.util.Tween.EASING.easeInBounce(
            t * 2 - d,
            b + c / 2,
            c / 2,
            d
  ...
  phina.define("phina.util.Random", {
    ...
    _static: {
      ...
      uuid: function () {
        ...
        if (
          phina.global.performance &&
          typeof phina.global.performance.now === "function"
        ) {
  ...
  phina.define("phina.asset.Texture", {
    ...
    _load: function (resolve) {
      ...
      this.domElement.onerror = function (e) {
        ...
        e.target.src =
          "http://dummyimage.com/128x128/444444/eeeeee&text=" + key;
      };
...
phina.namespace(function () {
  ...
  phina.define("phina.asset.Font", {
    ...
    load: function (path) {
      ...
      if (format !== "unknown") {
        var text =
          "@font-face { font-family: '{0}'; src: url({1}) format('{2}'); }".format(
            key,
            path,
            format
          );
...
(function () {
   ...
   */
  phina.input.Touch.prototype.getPointing =
    phina.input.Touch.prototype.getTouch;
  /**
   * @method
   * ポインティングを開始したかを取得(mouse との差異対策)
   */
  phina.input.Touch.prototype.getPointingStart =
    phina.input.Touch.prototype.getTouchStart;
  /**
   * @method
   * ポインティングを終了したかを取得(mouse との差異対策)
   */
  phina.input.Touch.prototype.getPointingEnd =
    phina.input.Touch.prototype.getTouchEnd;
})();
...
phina.namespace(function () {
  ...
  phina.define("phina.input.Keyboard", {
    ...
    getKeyAngle: function () {
      ...
      if (
        arrowBit !== 0 &&
        phina.input.Keyboard.ARROW_BIT_TO_ANGLE_TABLE.hasOwnProperty(arrowBit)
      ) {
...
phina.namespace(function () {
  ...
  phina.define("phina.input.GamepadManager", {
    ...
    update: function () {
      ...
      for (var i = 0, end = this._created.length; i < end; i++) {
        ...
        if (
          rawgamepad.timestamp &&
          rawgamepad.timestamp === this._prevTimestamps[i]
        ) {
  ...
  phina.define("phina.input.Gamepad", {
    ...
    getStickDirection: function (stickId) {
      stickId = stickId || 0;
      return this.sticks
        ? this.sticks[stickId].clone()
        : phina.geom.Vector2(0, 0);
    },
...
phina.namespace(function () {
  ...
  phina.define("phina.graphics.Canvas", {
    ...
    polygon: function (x, y, size, sides, offsetAngle) {
      ...
      this.moveTo(
        x + Math.cos(radOffset) * size,
        y + Math.sin(radOffset) * size
      );
    ...
    strokePolygon: function (x, y, radius, sides, offsetAngle) {
      return this.beginPath()
        .polygon(x, y, radius, sides, offsetAngle)
        .stroke();
    },
  ...
  phina.define("phina.display.DisplayElement", {
    ...
    _calcWorldAlpha: function () {
      ...
      if (!this.parent) {
        ...
        var worldAlpha =
          this.parent._worldAlpha !== undefined ? this.parent._worldAlpha : 1.0;
        // alpha
  ...
  var Shape = phina.define("phina.display.Shape", {
    ...
    _static: {
      ...
      watchRenderProperties: function (keys) {
        var watchRenderProperty =
          this.watchRenderProperty || Shape.watchRenderProperty;
        keys.each(function (key) {
  ...
  phina.define("phina.display.DomApp", {
    ...
    init: function (options) {
      ...
      this.keyboard.on(
        ...
        function (e) {
          this.currentScene &&
            this.currentScene.flare("keydown", {
              keyCode: e.keyCode,
            });
        }.bind(this)
      );
      ...
      this.keyboard.on(
        ...
        function (e) {
          this.currentScene &&
            this.currentScene.flare("keypress", {
              keyCode: e.keyCode,
            });
        }.bind(this)
      );
...
phina.namespace(function () {
  ...
  phina.define("phina.effect.Wave", {
    ...
    init: function (options) {
      ...
      tweener.to({ scaleX: 2, scaleY: 2, alpha: 0 }, 500).call(function () {
        this.remove();
      }, this);
    },
  });
...
phina.namespace(function () {
  ...
  var LabelArea = phina.define("phina.ui.LabelArea", {
    ...
    _defined: function () {
      ...
      ["text", "width", "fontSize", "fontWeight", "fontFamily"].forEach(
        function (key) {
          this.$watch(key, func);
        },
        this.prototype
...
phina.namespace(function () {
  ...
  phina.define("phina.game.ManagerScene", {
    ...
    replaceScene: function (label, args) {
      ...
      if (!data) {
        console.error(
          "phina.js error: `{0}` に対応するシーンがありません.".format(label)
        );
      }
  ...
  phina.define("phina.box2d.Box2dBody", {
    ...
    init: function (params) {
      ...
      this.on("attached", function () {
        ...
        var p = new b2.Vec2(
          target.x / this.world._scale,
          target.y / this.world._scale
        );
